...
object Libs {
    ...
    val retrofit = "com.squareup.retrofit2:converter-gson:${Versions.retrofit}"
    val retrofitLogInterceptor = "com.squareup.okhttp3:logging-interceptor:${Versions.retrofitLogInterceptor}"
